...
public class PasswordCrypter
{
    ...
    public static long[] PasswordKey = new long[]{
    ...
    public static void decrypt(long[] Password)
    {
        for (byte i = 1; i >= 0; i = (byte) (i - 1))
        {
            ...
            {
                num = ((long) Assembler.rollRight((num & 0xFFFFFFFFL) - (PasswordCrypter.PasswordKey[(j * 2) + 7] & 0xFFFFFFFFL), (byte) (num2 & 0xFFFFFFFFL), (byte) 0x20)) ^ (num2 & 0xFFFFFFFFL);
                num2 = ((long) Assembler.rollRight((num2 & 0xFFFFFFFFL) - (PasswordCrypter.PasswordKey[(j * 2) + 6] & 0xFFFFFFFFL), (byte) (num & 0xFFFFFFFFL), (byte) 0x20)) ^ (num & 0xFFFFFFFFL);
            }
